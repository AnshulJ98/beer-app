...
const beers_resolver_1 = require("./beers.resolver");
let BeersModule = class BeersModule {
};
exports.BeersModule = BeersModule;
exports.BeersModule = BeersModule = __decorate([
    (0, common_1.Module)({
        providers: [beers_service_1.BeersService, beers_resolver_1.BeersResolver],
    })
], BeersModule);
